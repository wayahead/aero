...
print("[==]: change_password_self via admin_topease")
...
url = 'http://127.0.0.1:3000/api/v1/me/passwd'
error_flag = False
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: change_password_self was failed')
    exit(1)
  else:
    print('-inf: change_password_self was successful')

# Testcase 2

print("[==]: change_password_self back via admin_topease")
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: change_password_self back was failed')
    exit(1)
  else:
    print('-inf: change_password_self back was successful')
    exit(0)
