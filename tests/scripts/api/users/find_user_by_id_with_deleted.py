...
url = 'http://127.0.0.1:3000/api/v1/users_with_deleted/59acad3e-64cd-4e3d-9bea-0612703d5f8b'
error_flag = False
try:
...
url = 'http://127.0.0.1:3000/api/v1/users_with_deleted/40899938-17c4-4d5f-83b8-1967c55db5d3'
error_flag = False
try:
  response = requests.get(url, headers=headers, timeout=5)
  # print("-inf:", response.headers)
...
url = 'http://127.0.0.1:3000/api/v1/users_with_deleted/7986d6b3-f57c-489e-a645-859454cc997f'
error_flag = False
try:
  response = requests.get(url, headers=headers, timeout=5)
  # print("-inf:", response.headers)
