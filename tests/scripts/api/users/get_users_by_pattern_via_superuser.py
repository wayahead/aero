...
print("[==]: get_users_by_pattern via superadmin")
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: get_users_by_pattern via superadmin was failed')
    exit(1)
  else:
    print('-inf: get_users_by_pattern via superadmin was successful')
    exit(0)
