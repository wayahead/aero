...
url = 'http://127.0.0.1:3000/api/v1/users_with_deleted?user_id=5978a878-0208-472a-95c5-0a962268e408'
error_flag = False
try:
...
url = 'http://127.0.0.1:3000/api/v1/users_with_deleted?user_id=5fea1ab8-59fa-4b18-9a27-53d64dc1fa90'
error_flag = False
try:
  response = requests.get(url, headers=headers, timeout=5)
  # print("-inf:", response.headers)
