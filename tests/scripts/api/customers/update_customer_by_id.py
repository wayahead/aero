...
url = 'http://127.0.0.1:3000/api/v1/customers/bbf5e39a-f351-4381-b1a4-0837991761d7'
error_flag = False
...
data = json.dumps({
  "customer": {
    "name": "TestCompany",
    "status": "ACTIVATED",
    "description": "TestCompany Technology Ltd.",
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: update_customer_by_id was failed')
    exit(1)
  else:
    print('-inf: update_customer_by_id was successful')
    exit(0)
