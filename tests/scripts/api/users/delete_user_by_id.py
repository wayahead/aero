...
print("[==]: delete_user_by_id via superadmin")
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: delete_user_by_id via superadmin was failed')
    exit(1)
  else:
    print('-inf: delete_user_by_id via superadmin was successful')

# Testcase 2

print("[==]: delete_user_by_id via admin_bewise")
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: delete_user_by_id via admin_bewise was failed')
    exit(1)
  else:
    print('-inf: delete_user_by_id via admin_bewise was successful')
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: delete_user_by_id via admin_topease was failed')
    exit(1)
  else:
    print('-inf: delete_user_by_id via admin_topease was successful')
    exit(0)
