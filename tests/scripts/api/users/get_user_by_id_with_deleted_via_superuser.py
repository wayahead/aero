...
url = 'http://127.0.0.1:3000/api/v1/users_with_deleted?user_id=2b4fdbfb-2c1a-4338-881f-1ef196cb22e1'
error_flag = False
try:
...
url = 'http://127.0.0.1:3000/api/v1/users_with_deleted?user_id=39588444-d153-42fa-a3c4-5b3cad4471e5'
error_flag = False
try:
  response = requests.get(url, headers=headers, timeout=5)
  # print("-inf:", response.headers)
