...
print("testcase: create_user via admin with different customer")
...
# Handle ValueError
  ...
  if error_flag:
    print('err: create_user via admin was failed')
    exit(1)
  else:
    print('inf: create_users via admin was successful')

# Testcase 2

print("testcase: create_user via admin without status, customer and roles")
...
# Handle ValueError
  ...
  if error_flag:
    print('err: create_user with admin without status, customer and roles was failed')
    exit(1)
  else:
    print('inf: create_user with admin without status, customer and roles was successful')
    exit(0)
