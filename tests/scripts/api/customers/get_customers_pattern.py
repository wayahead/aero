...
print("[==]: get_customers_pattern via superadmin")
...
url = 'http://127.0.0.1:3000/api/v1/customers?customer_pattern=%'
error_flag = False
try:
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: get_customers_pattern was failed')
    exit(1)
  else:
    print('-inf: get_customers_pattern was successful')
    exit(0)
