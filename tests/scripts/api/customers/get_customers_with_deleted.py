...
print("[==]: get_customers_with_deleted via superadmin")
...
url = 'http://127.0.0.1:3000/api/v1/customers_with_deleted'
error_flag = False
try:
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: get_customers_with_deleted was failed')
    exit(1)
  else:
    print('-inf: get_customers_with_deleted was successful')
    exit(0)
