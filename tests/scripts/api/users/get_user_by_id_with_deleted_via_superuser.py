...
#url = 'http://127.0.0.1:3000/api/v1/users_with_deleted?user_name=admin_topease'
url = 'http://127.0.0.1:3000/api/v1/users_with_deleted?user_id=a066902a-2b9b-4925-af8a-46a4322332e0'
error_flag = False
try:
...
#url = 'http://127.0.0.1:3000/api/v1/users_with_deleted?user_name=topease'
url = 'http://127.0.0.1:3000/api/v1/users_with_deleted?user_id=59acad3e-64cd-4e3d-9bea-0612703d5f8b'
error_flag = False
try:
  response = requests.get(url, headers=headers, timeout=5)
  # print("-inf:", response.headers)
