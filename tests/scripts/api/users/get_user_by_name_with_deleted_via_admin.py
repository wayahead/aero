...
print("[==]: get_user_by_name via admin_topease")
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: get_user_by_name via admin_topease was failed')
    exit(1)
  else:
    print('-inf: get_user_by_name via admin_topease was successful')
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: get_user_by_name via admin_bewise was failed')
    exit(1)
  else:
    print('-inf: get_user_by_name via admin_bewise was successful')
    exit(0)
