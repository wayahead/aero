...
print("[==]: suspend_admin_topease via superadmin")
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: suspend_admin_bewise via superadmin was failed')
    exit(1)
  else:
    print('-inf: suspend_admin_bewise via superadmin was successful')
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: suspend_superadmin_topease was failed')
    exit(1)
  else:
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: suspend_superadmin_bewise was failed')
    exit(1)
  else:
    print('-inf: suspend_superadmin_bewise was successful')
    exit(0)
