...
url = 'http://127.0.0.1:3000/api/v1/users/suspend/5978a878-0208-472a-95c5-0a962268e408'
error_flag = False
...
url = 'http://127.0.0.1:3000/api/v1/users/suspend/5fea1ab8-59fa-4b18-9a27-53d64dc1fa90'
error_flag = False
