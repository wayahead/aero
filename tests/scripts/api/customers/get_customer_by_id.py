...
url = 'http://127.0.0.1:3000/api/v1/customers?customer_id=bbf5e39a-f351-4381-b1a4-0837991761d7'
error_flag = False
try:
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: get_customer_by_id via superadmin was failed')
    exit(1)
  else:
    print('-inf: get_customer_by_id via superadmin was successful')
    exit(0)
