...
# Handle ValueError
  ...
  if error_flag:
    print('*err: find_user_by_name via admin_bewise was failed')
    exit(1)
  else:
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: find_user_by_name via admin_topease was failed')
    exit(1)
  else:
    print('-inf: find_user_by_name via admin_topease was successful')
    exit(0)
