...
print("[==]: update_admin_topease via superadmin")
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: update_admin_topease via superadmin was failed')
    exit(1)
  else:
    print('-inf: update_admin_topease via superadmin was successful')

# Testcase 2

print("[==]: update_admin_bewise with superadmin")
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: update_admin_bewise via superadmin was failed')
    exit(1)
  else:
    print('-inf: update_admin_bewise via superadmin was successful')

# Testcase 3

print("[==]: update_superadmin_topease")
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: update_superadmin_topease was failed')
    exit(1)
  else:
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: update_superadmin_bewise was failed')
    exit(1)
  else:
    print('-inf: update_superadmin_bewise was successful')
    exit(0)
