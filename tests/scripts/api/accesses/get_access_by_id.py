...
print("[==]: get_access_by_id via superadmin")
...
#url = 'http://127.0.0.1:3000/api/v1/accesses?access_app=testapp'
url = 'http://127.0.0.1:3000/api/v1/accesses?access_id=6320fe9b-4157-4abc-b2d1-c43f763f76cc'
error_flag = False
try:
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: get_access_by_id was failed')
    exit(1)
  else:
    print('-inf: get_access_by_id was successful')
    exit(0)
