...
print("[==]: get_users_with_deleted via superadmin")
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: get_users_with_deleted via superadmin was failed')
    exit(1)
  else:
    print('-inf: get_users_with_deleted via superadmin was successful')
    exit(0)
