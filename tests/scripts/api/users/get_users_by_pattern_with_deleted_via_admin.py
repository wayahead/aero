...
print("[==]: get_users_by_pattern_with_deleted via admin_topease")
...
url = 'http://127.0.0.1:3000/api/v1/users_with_deleted?user_pattern=%'
error_flag = False
try:
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: get_user_by_pattern_with_deleted via admin_topease was failed')
    exit(1)
  else:
    print('-inf: get_user_by_pattern_with_deleted via admin_topease was successful')
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: get_users_by_pattern_with_deleted via admin_bewise was failed')
    exit(1)
  else:
    print('-inf: get_users_by_pattern_with_deleted via admin_bewise was successful')
    exit(0)
