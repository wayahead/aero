...
# Handle ValueError
  ...
  if response.status_code == requests.codes.ok:
    print('Sign_in was successful')
    print(json_data)
  else:
    print('Sign_in failed with status code:', response.status_code)
    print(json_data)
    exit(1)
...
# Handle ValueError
  ...
  if response.status_code == requests.codes.ok:
    print('Me was successful')
    print(json_data)
    exit(0)
  else:
    print('Me failed with status code:', response.status_code)
    print(json_data)
    exit(1)
