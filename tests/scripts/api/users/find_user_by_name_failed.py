...
print("[==]: find_user_by_name_failed via admin")
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: find_user_by_name_failed via admin was failed')
    exit(1)
  else:
    print('-inf: find_user_by_name_failed via admin was successful')

print("[==]: find_user_by_name_failed via admin_wo")
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: find_user_by_name_failed via admin_wo was failed')
    exit(1)
  else:
    print('-inf: find_user_by_name_failed via admin_wo was successful')
    exit(0)
