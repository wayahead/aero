...
print("[==]: update_access_superadmin")
...
url = 'http://127.0.0.1:3000/api/v1/accesses/6320fe9b-4157-4abc-b2d1-c43f763f76cc'
error_flag = False
...
data = json.dumps({
  "access": {
    ...
    "description": "testapp credential updated",
    "preferences": {"digest": "md5", "cipher": "aes-256-cbc"}
  }
})
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: update_access_superadmin was failed')
    exit(1)
  else:
    print('-inf: update_access_superadmin was successful')
    exit(0)
