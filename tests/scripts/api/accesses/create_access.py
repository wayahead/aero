...
print("[==]: create_access_superadmin")
...
url = 'http://127.0.0.1:3000/api/v1/accesses'
error_flag = False
...
data = json.dumps({
  "access": {
    "app": "testapp",
    "status": "created",
    "description": "testapp credential"
  }
})
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: create_access_superadmin was failed')
    exit(1)
  else:
    print('-inf: create_access_superadmin was successful')

# Testcase 2

print("[==]: create_access_superadmin_topease")
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: create_access_superadmin_topease was failed')
    exit(1)
  else:
    print('-inf: create_access_superadmin_topease was successful')

# Testcase 3

print("[==]: create_access_admin_topease")
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: create_access_admin_topease was failed')
    exit(1)
  else:
    print('-inf: create_access_admin_topease was successful')

# Testcase 4

print("[==]: create_access_test_topease")
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: create_access_test_topease was failed')
    exit(1)
  else:
    print('-inf: create_access_test_topease was successful')
    exit(0)
