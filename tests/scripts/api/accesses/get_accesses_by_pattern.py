...
print("[==]: get_accesses_pattern via superadmin")
...
url = 'http://127.0.0.1:3000/api/v1/accesses?access_pattern=test%'
error_flag = False
try:
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: get_accesses_by_pattern was failed')
    exit(1)
  else:
    print('-inf: get_accesses_by_pattern was successful')
    exit(0)
