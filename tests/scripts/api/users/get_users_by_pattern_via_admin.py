...
url = 'http://127.0.0.1:3000/api/v1/users?user_pattern=%'
error_flag = False
try:
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: get_user_by_pattern via admin_topease was failed')
    exit(1)
  else:
    print('-inf: get_user_by_pattern via admin_topease was successful')
