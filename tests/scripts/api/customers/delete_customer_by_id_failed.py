...
print("[==]: delete_customer_by_id_failed (invalid id)")
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: delete_customer_by_id_failed (invalid id) was failed')
    exit(1)
  else:
    print('-inf: delete_customer_by_id_failed (invalid id) was successful')
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: find_customer_by_id_failed (not found) was failed')
    exit(1)
  else:
    print('-inf: find_customer_by_id_failed (not found) was successful')
    exit(0)
