...
#url = 'http://127.0.0.1:3000/api/v1/customers/name/suspend/TestCompany'
url = 'http://127.0.0.1:3000/api/v1/customers/suspend/bbf5e39a-f351-4381-b1a4-0837991761d7'
error_flag = False
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: suspend_customer_by_id was failed')
    exit(1)
  else:
    print('-inf: suspend_customer_by_id was successful')
    exit(0)
