...
print("[==]: activate_user_topease via admin_topease")
...
print("[==]: activate_user_bewise with admin_bewise")
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: activate_user_bewise via admin_bewise was failed')
    exit(1)
  else:
    print('-inf: activate_user_bewise via admin_bewise was successful')

# Testcase 3

print("[==]: activate_user_topease_failed")
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: activate_user_topease was failed')
    exit(1)
  else:
    print('-inf: activate_user_topease was successful')

# Testcase 4

print("[==]: activate_user_bewise_failed")
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: activate_user_bewise was failed')
    exit(1)
  else:
    print('-inf: activate_user_bewise was successful')
    exit(0)
