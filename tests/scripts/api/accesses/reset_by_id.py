...
#url = 'http://127.0.0.1:3000/api/v1/accesses/reset/app/testapp'
url = 'http://127.0.0.1:3000/api/v1/accesses/reset/6320fe9b-4157-4abc-b2d1-c43f763f76cc'
error_flag = False
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: reset_access_superadmin was failed')
    exit(1)
  else:
    print('-inf: reset_access_superadmin was successful')
    exit(0)
