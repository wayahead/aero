class UpdateUserByNameRequestUser
...
class UpdateUserByNameRequest
  include JSON::Serializable
  property user : UpdateUserByNameRequestUser
end

class Api::Users::UpdateByName < ApiAction
  include Api::Auth::RequireAdmin

  put "/users/name/:user_name" do
    begin
