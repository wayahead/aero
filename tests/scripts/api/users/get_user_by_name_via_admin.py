...
print("[==]: get_user_by_name via admin_wo")
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: get_user_by_name via admin_wo was failed')
    exit(1)
  else:
    print('-inf: get_user_by_name via admin_wo was successful')

print("[==]: get_user_by_name via admin")
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: get_user_by_name via admin was failed')
    exit(1)
  else:
    print('-inf: get_user_by_name via admin was successful')
