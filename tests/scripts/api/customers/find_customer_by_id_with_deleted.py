...
#url = 'http://127.0.0.1:3000/api/v1/customers_with_deleted/name/TestCompany'
url = 'http://127.0.0.1:3000/api/v1/customers_with_deleted/bbf5e39a-f351-4381-b1a4-0837991761d7'
error_flag = False
try:
...
# Handle ValueError
  ...
  if error_flag:
    print('*err: find_customer_by_id was failed')
    exit(1)
  else:
    print('-inf: find_customer_by_id was successful')
    exit(0)
